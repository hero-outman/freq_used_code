...
setwd('/Users/jplab/Desktop/DAILY_CODE_DATA/2022-4/data/4-6_cut_tag_CSAW')
...
FOXA1_B14_rep1.peaks <- read.table("/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/MACS_allLen_noDUP_noChrM/FOXA1_B14_1/FOXA1_B14_1_peaks.narrowPeak", sep="\t")[,1:7]
FOXA1_B14_rep2.peaks <- read.table("/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/MACS_allLen_noDUP_noChrM/FOXA1_B14_2/FOXA1_B14_2_peaks.narrowPeak", sep="\t")[,1:7]
FOXA1_DMSO_rep1.peaks <- read.table("/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/MACS_allLen_noDUP_noChrM/FOXA1_DMSO_1/FOXA1_DMSO_1_peaks.narrowPeak", sep="\t")[,1:7]
FOXA1_DMSO_rep2.peaks <- read.table("/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/MACS_allLen_noDUP_noChrM/FOXA1_DMSO_2/FOXA1_DMSO_2_peaks.narrowPeak", sep="\t")[,1:7]
FOXA1_TGF_rep1.peaks <- read.table("/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/MACS_allLen_noDUP_noChrM/FOXA1_TGF_1/FOXA1_TGF_1_peaks.narrowPeak", sep="\t")[,1:7]
FOXA1_TGF_rep2.peaks <- read.table("/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/MACS_allLen_noDUP_noChrM/FOXA1_TGF_2/FOXA1_TGF_2_peaks.narrowPeak", sep="\t")[,1:7]
colnames(FOXA1_B14_rep1.peaks) <- c("chrom", "start", "end","name","score","strand","fold_enrichment")
colnames(FOXA1_B14_rep2.peaks) <- c("chrom", "start", "end","name","score","strand","fold_enrichment")
colnames(FOXA1_DMSO_rep1.peaks) <- c("chrom", "start", "end","name","score","strand","fold_enrichment")
colnames(FOXA1_DMSO_rep2.peaks) <- c("chrom", "start", "end","name","score","strand","fold_enrichment")
colnames(FOXA1_TGF_rep1.peaks) <- c("chrom", "start", "end","name","score","strand","fold_enrichment")
colnames(FOXA1_TGF_rep2.peaks) <- c("chrom", "start", "end","name","score","strand","fold_enrichment")
...
# attention: if use TGF1 intersect TGF2, only 20~ peaks be intersected! to little! So try only TGF2
FOXA1_TGF.peaks <- intersect(FOXA1_TGF_rep2.peaks, FOXA1_TGF_rep2.peaks)
...
pe.bams <- c("/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/noDUP_nochrM_bam/FOXA1_B14_1.noDup.nochrM.sortpos.bam",
             "/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/noDUP_nochrM_bam/FOXA1_B14_2.noDup.nochrM.sortpos.bam",
             "/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/noDUP_nochrM_bam/FOXA1_DMSO_1.noDup.nochrM.sortpos.bam",
             "/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/noDUP_nochrM_bam/FOXA1_DMSO_2.noDup.nochrM.sortpos.bam",
             "/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/noDUP_nochrM_bam/FOXA1_TGF_2.noDup.nochrM.sortpos.bam", # note:here try to use TGF2
             "/Users/jplab/Desktop/snakepipes_Data/CUT_TAG_snakepipes/FOXA1_H3K27ac/noDUP_nochrM_bam/FOXA1_TGF_2.noDup.nochrM.sortpos.bam"
             )
...
peak.counts.filt <- peak.counts[peak.abundances > 2.0, ] # only use peaks logCPM > -3
...
write.table(final.merged.peaks, "FOXA1.B14_vs_FOXA1.DMSO_all.tsv", sep="\t", quote=F, col.names=T, row.names=F)
write.table(final.merged.peaks.FDRsig, "FOXA1.B14_vs_FOXA1.DMSO_FDRsig.tsv", sep="\t", quote=F, col.names=T, row.names=F)
...
write.table(final.merged.peaks.pvalue.sig, "FOXA1.B14_vs_FOXA1.DMSO_pvalue_significant.tsv", sep="\t", quote=F, col.names=T, row.names=F)
